...
public class MiUbicacionActivity extends Activity {
                                            ...
                                            public boolean onItemLongPress(final int index, final OverlayItem item) {
                                                    Toast.makeText(
                                                    		MiUbicacionActivity.this,
                                                                    item.mTitle , Toast.LENGTH_LONG).show();
                                                    //cambios chichan
                                                    Intent intent = new Intent(MiUbicacionActivity.this, BuscarProductos.class);
...
//            	posicionActualOverlay.setLocation(gPt0);
		    ...
		    mHandler.postDelayed(Timer_Tick, 5000); //cada 30 segundos connsulta a la BD
    		//////////////////////////////////////////////////////////// fin timer
...
//            Location loc = gpsLocationManager.getLastKnownLocation("gps");
            ...
            if(loc != null) {
                ...
                if (latitude!=0){
                    ...
                    Toast.makeText(MiUbicacionActivity.this,"Longitude is  "+longitude + "   Latitude is   "+latitude, Toast.LENGTH_LONG).show();
                }                
            }
        }				
	}
...
//	            Location loc = gpsLocationManager.getLastKnownLocation("gps");
	    	...
	    	Toast.makeText(MiUbicacionActivity.this, "No hay GPS", Toast.LENGTH_LONG).show();
	    }
	...
	public static class GpsLocationListener implements LocationListener {
	    ...
	    public void onLocationChanged(Location loc) {
	        ...
	        if (loc != null) {
	            ...
	            double latitude = loc.getLatitude();
	            double longitude = loc.getLongitude();
	            Log.e("Cambio pos", "lat:"+latitude+" "+longitude);
