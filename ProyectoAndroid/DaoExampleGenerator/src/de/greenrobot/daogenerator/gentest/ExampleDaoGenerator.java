...
public class ExampleDaoGenerator {
	...
	private static void addCuestionario(Schema schema) {
		Entity preguntaxalumno = schema.addEntity("Cuestionario");
		preguntaxalumno.addIdProperty();
		preguntaxalumno.addLongProperty("IdAlumno");
		preguntaxalumno.addLongProperty("IdPregunta");
		preguntaxalumno.addStringProperty("Comentarios");		
	}
