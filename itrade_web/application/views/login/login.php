    ...
    <body>
      <!--  <div id="header">
            <div class="container content">
                <h1><a href="<? echo base_url() ?>home" title="Back to home">i-Trade</a></h1>

                <? if ($this->session->userdata('logged_in') && (isset($username) && isset($name))) { ?>
                    <div class="loginInfos"> You're logged in as <strong><? echo trim($username); ?></strong>.  <? echo anchor(base_url() . 'home/logout', 'Logout', array('title' => 'Salir de la sesion')); ?> </div>
                <? } else { ?>
