            ...
            <div class="contenido_principal" style="width:70%; height:100%;  min-width:650px; max-width:650px;">
                ...
                <fieldset class="left">
                    ...
                    <p>
                        ...
                        <?php $monto = array('name' => 'monto', 'id' => 'monto', 'size' => 15, 'class' => 'mandatory', 'title' => 'Por favor ingrese el monto', 'value' =>  set_value('monto')); ?>
                        <?= form_input($monto) ?>
                    </p>
                ...
                <p class="clear">
                    ...
                    <input type="button" value="Cancelar" class="button" onclick="window.location='<?= base_url() ?>admin/usuario_controller/metas_user/<?echo $idusuario?>'"/>
                </p>
                <?= form_close(); ?>
