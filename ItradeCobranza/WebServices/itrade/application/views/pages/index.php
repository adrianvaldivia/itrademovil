<div id="login_principal">
    <fieldset style="margin: 10px;">
        <legend style="font-size:20px;">Intranet</legend>   
        ...
        <?php echo form_open("validate/validate_admin", array('id'=>'loginForm', 'name'=>'loginForm')); ?>            
			<table style="margin:0px auto;">
                <tr>
                    <td style="width: 45%;text-align:right;padding:5px;"><label>Usuario: </label></td>
                    <td style="width: 55%">
                ...
                <tr>
                    <td style="text-align:right;padding:5px;"><label>Contrase&ntilde;a: </label></td>
                    <td>
