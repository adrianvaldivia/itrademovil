...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AlumnoDao.createTable(db, ifNotExists);
        PreguntaDao.createTable(db, ifNotExists);
        PreguntaxAlumnoDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ElementoListaDao.dropTable(db, ifExists);
        AlumnoDao.dropTable(db, ifExists);
        PreguntaDao.dropTable(db, ifExists);
        PreguntaxAlumnoDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AlumnoDao.class);
        registerDaoClass(PreguntaDao.class);
        registerDaoClass(PreguntaxAlumnoDao.class);
    }
