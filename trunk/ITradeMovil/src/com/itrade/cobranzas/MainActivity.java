...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login2);//Aca se le indica que va a utilizar el layout main
        
        // Importing all assets like buttons, text fields
	    textView_Usuario  = (EditText) findViewById(R.id.autoCompleteTextView1);// Este es el input del Nombre de usuario
	    textView_Password  = (EditText) findViewById(R.id.editText1);// Este el input del password
	    button_Ingresar = (Button) findViewById(R.id.button1); //El boton que dice incgresar
